...
describe('CoordinatesConversion', () => {
  describe('Parsing', () => {
    ...
    it('throws on out of range values', () => {
      expect(() => validateRange(95, 0)).toThrow(/Latitude/);
      expect(() => validateRange(0, 190)).toThrow(/Longitude/);
    });
    ...
    it('throws on invalid DM string', () => {
      expect(() => parseCoordinateString('invalid', false, true)).toThrow(/Could not parse DM/);
    });
